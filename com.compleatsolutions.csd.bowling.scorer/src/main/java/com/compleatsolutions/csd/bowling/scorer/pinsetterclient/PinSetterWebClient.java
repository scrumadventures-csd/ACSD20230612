...
/*         +==================================================================+         */
/*                                                                                      */
/* MODULE:      PinSetterWebClient.java                                                 */
/*                                                                                      */
/*======================================================================================*/
...
import com.compleatsolutions.csd.bowling.scorer.pinsetterclient.PinSetterJsonMapper;
import com.compleatsolutions.csd.bowling.scorer.pinsetterclient.PinSetterRequestResponse;
...
/*======================================================================================*/
/*======================================================================================*/
/* CLASS:       PinSetterWebClient                                                      */
/**
 * Web client for the Pin Setter web serviceds for testing purposes.
 *
...
public  class  PinSetterWebClient
{
    /*==================================================================================*/
    /*=================================== Attributes ===================================*/
    /*==================================================================================*/
    ...
    /*==================================================================================*/
        ...
        /**
         * Invokes the Pin Setter <i>register</i> web service.
         *
...
//                                                   .add   ("action",      myAction)
//                                                   .add   ("pinSetterRequestResponse",     myJsonPayload)
//                                                   .build ();
//
//                        /*==============================================================*/
...
//        /**
//         * Invokes the Pin Setter <i>nextScore</i> web service.
//         *
//         * @param  aRequestUrl  The root of the host URL.
...
//
//         PinSetterRequestResponse myPinSetterRequest = new PinSetterRequestResponse ();
//
//         myPinSetterRequest.setAction    (myAction);
//         myPinSetterRequest.setPayload   (myJsonPayload);
//         myPinSetterRequest.setReference (myReference);
//
//         String myRequestString = PinSetterJsonMapper.mapObjectToJsonString (myPinSetterRequest);
...
////                                                 .add   ("username",   "vip")
////                                                 .add   ("password",   "secret")
//                                                   .add   ("pinSetterRequestResponse",  myRequestString)
//                                                   .build ();
//
//                        /*==============================================================*/
//                        /* Execute the HTTP request                                     */
...
//
         ...
         */
        /*==============================================================================*/
   public  String  invokeRegisterHttp (
                                       String  aRequestUrl,
                                       int     aFrameCount,
                                       int     aPinCount,
                                       int     aRollsPerFrame,
                                      ...
                                      )
   {
      ...
      try {
        ...
        /*==============================================================================*/
        /* OPERATION:   invokeCheckHttp                                                 */
        /**
         * Invokes the Pin Setter <i>check</i> web service.
         *
         * @param  aRequestUrl  The root of the host URL.
         * @param  aId          The identifier of te registered pin setter instance.
         * @return :String -    The object representing the response content.
...
//    String myRequestUrl   = (aArgs.length > 1) ? aArgs [1] : "http://127.0.0.1:8080/pinsetter/";
      String myRequestUrl   = (aArgs.length > 1) ? aArgs [1] : "http://pinsetter.herokuapp.com/pinsetter/";
...
//    String myScoreString  = (aArgs.length > 5) ? aArgs [5] : "1-2-3-4-5-6-7-8-9/X12";
      ...
      if (myInvocation.contains ("H")) {
         myResponseString = myPinSetterWebClient.invokeRegisterHttp  (
                                                                      myRequestUrl,
         ...
         for (int i = 1; ; i++) {
            myResponseString = myPinSetterWebClient.invokeRollHttp (myRequestUrl, myId);
         ...
         myResponseString = myPinSetterWebClient.invokeCheckHttp (myRequestUrl, myId);
...
//         myResponseString = myPinSetterWebClient.invokeRegisterJson (
//                                                                      myRequestUrl,
//                                                                      Integer.parseInt (myFramesString),
//                                                                      Integer.parseInt (myPinsString),
//                                                                      Integer.parseInt (myRollsString),
...
//
//         for (int i = 1; ; i++) {
//            myResponseString = myPinSetterWebClient.invokeRollJson (myRequestUrl, myId);
//
