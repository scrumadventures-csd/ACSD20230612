                ...
                >
                    ...
                    <tr>
                        {visibleColumns.map((column, index) => {
                            className = 'py-3 pl-3 pr-6 text-center text-sm leading-5 font-semibold neutral-900 border-0 relative';
                            ...
                            return (
                                <th
                                    ...
                                    style={{
                                        ...
                                        display: (column.header !== undefined && !column.header) || column.hidden === true ? 'none' : undefined
                                    }}
                            ...
                            return (
                                <React.Fragment key={index}>
                                    ...
                                    <tr className={(index % 2 === 1 || open ? 'bg-neutral-50 dark:bg-transparent ' : 'dark:bg-neutral-600 ') + (open ? styles.open : '')}>
                                            ...
                                            className = 'p-3 text-center text-sm leading-5 font-light neutral-900 border-0 border-t border-x border-t-neutral-200 border-x-neutral-400 dark:border-t-neutral-500 relative';
                                            className = classNames(
                                                className,
                                            ...
                                            return (
                                                <td
                                                    ...
                                                    onClick={column.responsive.type === 'control' ? (event) => {
